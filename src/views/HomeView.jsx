...
import { Calendar, ShoppingBag, Sparkles, Star, Award, ShieldCheck, ArrowRight, Heart, Gift, Clock, ImageOff } from 'lucide-react';
    ...
    <div className="w-full flex flex-col gap-8 mx-auto">
      ...
      <section className="w-full bg-white/[0.04] backdrop-blur-2xl border border-amber-400/25 rounded-3xl p-6 flex flex-wrap items-center justify-between gap-4 mx-auto shadow-apple-glass">
        <div className="flex items-center gap-4">
          <div className="bg-amber-400/15 border border-amber-400/30 p-3.5 rounded-2xl text-amber-300 shrink-0" aria-hidden="true">
            <Gift size={26} />
          </div>
          <div>
      ...
      <section className="w-full mx-auto">
        ...
        {featuredServices.length === 0 ? (
          <div className="empty-state">
            ...
            <h3 className="text-lg font-bold text-white mb-2">No Services Available</h3>
            <p className="text-sm text-slate-400">Check back soon — new campus services are being added!</p>
          </div>
        ) : (
      ...
      <section className="w-full mx-auto">
        ...
        {featuredProducts.length === 0 ? (
          <div className="empty-state">
            ...
            <h3 className="text-lg font-bold text-white mb-2">No Featured Products</h3>
            <p className="text-sm text-slate-400">Featured products will appear here soon!</p>
          </div>
        ) : (
